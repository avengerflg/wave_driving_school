<!-- filepath: resources/views/admin/instructors/edit.blade.php -->
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="fw-bold m-0">
                                ...
                                <span class="text-muted fw-light">Admin / Instructors /</span> Edit Instructor
                            </h4>
                            <div>
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <textarea 
                                    ...
                                    name="address" 
                                    rows="2"
                                >{{ old('address', $instructor->address) }}</textarea>
                                @error('address')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-0">
                                ...
                                >
                                    ...
                                    @foreach($suburbs as $suburb)
                                        <option value="{{ $suburb->id }}" {{ old('suburb_id', $instructor->suburb_id) == $suburb->id ? 'selected' : '' }}>
                                            {{ $suburb->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input 
                                    ...
                                    id="license_number" 
                                    name="license_number" 
                                    value="{{ old('license_number', $instructor->instructor->license_number) }}"
                                    required
                                >
                            ...
                            <div class="mb-3">
                                ...
                                @if($instructor->instructor->profile_image)
                                    <div class="mb-2">
                                        <img src="{{ asset('storage/' . $instructor->instructor->profile_image) }}" 
                                             class="img-thumbnail" 
                            ...
                            <div class="mb-0">
                                ...
                                <textarea 
                                    ...
                                    name="bio" 
                                    rows="4"
                                >{{ old('bio', $instructor->instructor->bio) }}</textarea>
                                @error('bio')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                                ...
                                                <div class="col-md-4 col-6 mb-1">
                                                    <div class="form-check">
                                                        <input 
                                                            ...
                                                            value="{{ $suburb->id }}" 
                                                            id="suburb{{ $suburb->id }}"
                                                            {{ in_array($suburb->id, old('service_suburbs', $serviceSuburbIds ?? [])) ? 'checked' : '' }}
                                                        >
